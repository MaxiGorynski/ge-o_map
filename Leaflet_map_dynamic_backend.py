...
csv_file = "/Users/supriyarai/Code/ge-o_map/Scotland_Census-2022-Output-Area-Full/UV901 - UK Armed Forces veterans (Full Geo).csv"
...
json_file = os.path.join(output_folder, f"43. UK Armed Forces Veterans.json")
